...
Inner sites usually do not need public internet proxies; they depend more on route reachability from the browser node to the intranet system. External SaaS sites may need a fixed proxy if they require a specific egress IP. 
