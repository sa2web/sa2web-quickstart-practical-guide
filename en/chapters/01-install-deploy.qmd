...
|---|---|
| Installation directory | Use the default if possible. If you customize it, use a dedicated directory and make sure the current user has enough permissions or have sudo privileges. |
